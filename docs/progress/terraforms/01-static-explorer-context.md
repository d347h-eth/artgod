...
- The overview renders 20 level groups and 60 transparent dashed-outline faces, with every level centered on one spine, gaps at triple the slab height, visible-stroke-only hit targets, and selection intentionally implemented as a no-op.
