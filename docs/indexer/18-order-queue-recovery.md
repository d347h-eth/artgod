...
individual-order demand, broad-maker and token validation. Two demand executors
continue after yielding while work remains and poll every second when idle.
