...
Read this area from the user's perspective before entering implementation
details.

1. [Public Alpha Scope](01-public-alpha-scope.md) defines the current product,
...
[unified backlog](../planning/01-unified-backlog.md), not in this user-facing
area.
