...
const baseURL = process.env.ARTGOD_E2E_PUBLIC_BASE_URL?.trim() || 'http://127.0.0.1:42703';
...
export default defineConfig({
	testDir: './e2e',
	outputDir: './test-results/playwright-bidding-automation-public',
	timeout: 45_000,
	expect: {
		timeout: 10_000
	},
	...
	retries: 0,
	webServer: {
		command: 'yarn dev:e2e:bidding:public',
		url: readinessURL,
