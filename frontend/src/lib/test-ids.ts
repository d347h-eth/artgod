...
export const TEST_IDS = {
	...
	BiddingPanelSelectionActivate: 'bidding-panel-selection-activate',
	BiddingPanelSelectionPause: 'bidding-panel-selection-pause',
	BiddingPanelSelectionArchive: 'bidding-panel-selection-archive',
