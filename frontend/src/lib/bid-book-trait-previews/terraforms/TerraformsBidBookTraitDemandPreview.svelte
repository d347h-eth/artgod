...
<style>
	.terraforms-bid-book-trait-preview {
		--terraforms-zone-palette-band-swatch-size: 0.7rem;
		--terraforms-biome-character-band-cell-size: 0.78rem;
		--terraforms-biome-character-band-font-size: 0.7rem;
		--terraforms-biome-character-band-padding-block: 0.12rem;
