...
export const BIDDING_DEFAULT_BID_BOOK_PROJECTION_THROTTLE_MS = 15_000;
export const BIDDING_DEFAULT_ORDER_LOOKUP_MAX_PAGES = 5;
export const BIDDING_DEFAULT_OPEN_SEA_OFFERS_PAGE_SIZE = 100;
export const BIDDING_DEFAULT_COMMAND_POLL_MS = 1_000;
export const BIDDING_DEFAULT_COMMAND_BATCH_SIZE = 20;
export const BIDDING_DEFAULT_COMMAND_MAX_ATTEMPTS = 5;
export const BIDDING_DEFAULT_COMMAND_CLAIM_TIMEOUT_MS = 5 * 60 * 1000;
