...
export const BIDDING_RUNTIME_METRIC_NAME = {
    ...
    ScanActive: "bidding_scan_active",
    ScanCompletedJobs: "bidding_scan_completed_jobs",
    ScanStartedAt: "bidding_scan_started_at_seconds",
    ScanLastProgressAt: "bidding_scan_last_progress_at_seconds",
    ScanLastSuccessAt: "bidding_scan_last_success_at_seconds",
    WorkActive: "bidding_work_active",
    WorkOldestStart: "bidding_work_oldest_started_at_seconds",
    WorkLastProgress: "bidding_work_last_progress_at_seconds",
    WorkLastSuccess: "bidding_work_last_success_at_seconds",
    ...
    CommandQueueDepth: "bidding_command_queue_depth",
    CommandOldestPendingAt: "bidding_command_oldest_pending_at_seconds",
    CommandStaleProcessing: "bidding_command_stale_processing",
    CommandDurableOutcomes: "bidding_command_durable_outcomes_total",
    HealthSampleSuccess: "bidding_health_sample_success",
    HealthLastSuccess: "bidding_health_last_success_at_seconds",
    Decisions: "bidding_decisions_total",
    JobPositions: "bidding_job_positions",
    JobConstraints: "bidding_job_constraints",
    ...
    SnapshotFreshness: "bidding_snapshot_freshness",
    SnapshotBackoff: "bidding_snapshot_backoff_collections",
    SnapshotOldestCompleteAt: "bidding_snapshot_oldest_complete_at_seconds",
    PublicationWatched: "bidding_publication_watched_collections",
    PublicationMissing: "bidding_publication_missing_collections",
    PublicationLagging: "bidding_publication_lagging_collections",
    PublicationOldestAt: "bidding_publication_oldest_at_seconds",
    PublicationOldestSnapshotAt:
        "bidding_publication_oldest_snapshot_at_seconds",
    OpenSeaOperations: "bidding_opensea_operations_total",
    OpenSeaInFlight: "bidding_opensea_in_flight",
    OpenSeaOldestStart: "bidding_opensea_oldest_started_at_seconds",
    OpenSeaLastProgress: "bidding_opensea_last_progress_at_seconds",
    OpenSeaLastSuccess: "bidding_opensea_last_success_at_seconds",
...
export const BIDDING_RUNTIME_CONFIGURATION_SETTING = {
    ...
    SnapshotMaxTtlMs: "snapshot_max_ttl_ms",
    SnapshotTtlMultiplier: "snapshot_ttl_multiplier",
